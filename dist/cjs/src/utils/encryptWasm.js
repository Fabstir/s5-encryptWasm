...
async function calculateB3hashFromFileEncrypt(file, encryptedKey) {
    ...
    while (position <= file.size) {
        ...
        const encryptedChunkUint8Array = (0, encrypt_file_1.encrypt_file_xchacha20)(chunkUint8Array, encryptedKey, 0x0, chunkIndex);
...
async function encryptFile(file, filename, encryptedKey, cid) {
    ...
    const encryptedFileBytes = (0, encrypt_file_1.encrypt_file_xchacha20)(fileContents, encryptedKey, 0x0);
    ...
    return new TransformStream({
        async transform(chunk, controller) {
            ...
            while (buffer.length >= chunkSize) {
                ...
                const encryptedChunkUint8Array = Promise.resolve((0, encrypt_file_1.encrypt_file_xchacha20)(chunk, key, 0x0, chunkIndex));
